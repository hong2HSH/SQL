...
```sql
SELECT smoking, COUNT(*) FROM healthcare WHERE smoking is NOT '' GROUP BY smoking;
```
```
smoking  COUNT(*)
-------  --------
...
```sql
SELECT is_drinking, COUNT(*) FROM healthcare WHERE is_drinking is NOT '' GROUP BY is_drinking;
```
```
is_drinking  COUNT(*)
-----------  --------
...
```sql
SELECT is_drinking, COUNT(*) FROM healthcare WHERE blood_pressure is NOT '' AND blood_pressure >= 200 GROUP BY is_drinking;
```
```
is_drinking  COUNT(*)
-----------  --------
